...
public class Data2 extends HttpServlet {
       public void doGet(HttpServletRequest request, HttpServletResponse response)
              ...
              try{
                     ...
                     PreparedStatement ps=con.prepareStatement("select * from teacher where tea_id=? and password=?");
                     ps.setString(1,tea_id);                   
                     ps.setString(2,password);
                     out.print("<center><table width=25% border=1>");
                     out.print("<center><h1>TEACHER INFORMATION:</h1></center>");
                     ...
                     out.print("<font color=\"white\"><marquee direction=\"left\" style=\"background:blue\">IF YOU DON'T FIND ANY  DATA PLEASE CHECK YOUR INPUT OTHERWISE CONTACT MANAGEMENT OF YOUR COLLEGE</marquee></font>");
              }catch (Exception e2)
                {
                    e2.printStackTrace();
                }
